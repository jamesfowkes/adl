...
static adl_string_buffer s_adl_buffer = {buffer, 9};
...
class DelimitedStreamParserTest : public CppUnit::TestFixture { 
    ...
    {
        DelimitedStreamParser parser(',', '\0', s_adl_buffer, on_string_parsed);
    ...
    {
        DelimitedStreamParser parser('>', ',', s_adl_buffer, on_string_parsed);

...
class Board(namedtuple("Board", ["type", "name", "devices", "settings", "info", "adl", "custom_code", "attrs"])):
	__slots__ = ()
	...
	def from_xml(cls, node):
		...
		return cls(board_type, name, devices, settings_dict, info, adl, filenames, board_node.attrib)

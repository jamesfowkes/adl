...
class RGBParameterTest : public CppUnit::TestFixture { 
    ...
    {
        RGBParam param = RGBParam(255, 10,20,30);
    ...
    void testRGBParameterSetReturnsTrueAndStateIsSet()
    {
        ...
        RGBParam param1 = RGBParam(255, 0,0,0);
        ...
        RGBParam param2 = RGBParam(255, 0,0,0);
    ...
    {
        RGBParam param = RGBParam(255, 0, 0, 0);
    ...
    {
        RGBParam param = RGBParam(255, 0, 0, 0, false);
        CPPUNIT_ASSERT(!param.set(256, 0, 0));
    ...
    {
        RGBParam param = RGBParam(255, 0, 128, 255);
        param.set(1,1,1);
        param.reset();
        CPPUNIT_ASSERT_EQUAL((uint16_t)0, param.get(eR));

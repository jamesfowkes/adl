...
Usage:
    adl.py <input_file> [--sketchbook=<parent_directory>] [--style=<style_file>]

Options:
    --sketchbook=<parent_directory>    The location to copy the generated sketch and files to
    --style=<style_file>               The Artistic Style file to use for styling output [default: astyle_defaults].

...
class Adafruit_MCP4725RAAT(GenericDevice, namedtuple("Adafruit_MCP4725RAAT", ["name", "i2c_address", "default", "min", "max"])):
    ...
    def declarations(self):
        return "static Adafruit_MCP4725RAAT {name} = Adafruit_MCP4725RAAT(0x{i2c_address:02X}, {default}, {min}, {max});".format(
